...
public class ApplyPass : ScriptableRenderPass
{
    ...
    //private RTHandle m_BlurTempTex;
    //private RTHandle m_FullRayMarchTex;
    ...
    public ApplyPass()
    {
        ...
        //m_BlurTempTex = RTHandles.Alloc("BlurTempTex");
        //m_FullRayMarchTex = RTHandles.Alloc("FullRayMarchTex");
        m_TemporaryColorTexture.Init("m_TemporaryColorTexture");
        m_TempColorTexHandle = RTHandles.Alloc("m_TempColorTexHandle");
        m_TempColorTexture = RTHandles.Alloc("m_TempColorTexture");
    }
